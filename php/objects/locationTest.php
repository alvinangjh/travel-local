...
$new_location = new Location("", $_POST["locTitle"], $_POST["locAddress"], $_POST["locPostalCode"], $_POST["locDesc"], $_POST["recDuration"],  $_POST["rating"], $_POST["imageUrl"], "", $_POST["latitude"], $_POST["longitude"], $_POST["venueType"], $_POST["businessContact"], $_POST["businessEmail"], $_POST["businessHrs"], $_POST["businessWeb"]);
